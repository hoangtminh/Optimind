...
const FeatureCard = React.memo(
	({ icon: Icon, title, description, bg, color, delay = 0 }) => {
		...
		return (
			<div
				ref={cardRef}
				className={`px-6 py-4 rounded-2xl ${bg} border-4 backdrop-blur-sm hover:scale-105 hover:rotate-1 hover:shadow-xl transition-all duration-100 cursor-pointer ${
					isVisible
	...
	const features = [
		{
			...
			bg: "bg-green-200/40 border-green-400/70",
		},
		{
			icon: Users,
			...
			bg: "bg-orange-200/40 border-orange-400/70",
		},
		{
			icon: Award,
			...
			bg: "bg-indigo-200/40 border-indigo-400/70",
		},
		{
			icon: TrendingUp,
			...
			bg: "bg-violet-200/40 border-violet-400/70",
		},
		{
			icon: Zap,
			...
			bg: "bg-cyan-200/40 border-cyan-400/70",
		},
		{
			icon: BookOpen,
			...
			bg: "bg-yellow-200/40 border-yellow-400/70",
		},
	];
