...
import { ChevronLeft, ChevronRight, Plus, Calendar, Clock, BookOpen, Target, Edit, Trash2 } from "lucide-react"
...
export default function CalendarPage() {
  ...
  const addEvent = () => {
    if (newEvent.title && newEvent.subject && newEvent.date && newEvent.startTime) {
      const event = {
        id: events.length + 1,
        ...newEvent,
        completed: false,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Quản lý lịch trình học tập và sự kiện</p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Thêm sự kiện học tập vào lịch của bạn</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="event-subject">Môn học</Label>
                  <Select
                  ...
                  return (
                    ...
                    >
                      {day && (
                        <>
                          <div
                            className={`text-sm font-medium mb-1 ${isToday(day) ? "text-cyan-700" : "text-gray-900"}`}
                          >
                            {day.getDate()}
                          </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>{new Date().toLocaleDateString("vi-VN")}</CardDescription>
            </CardHeader>
            <CardContent>
              {todayEvents.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">Không có sự kiện nào hôm nay</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Các sự kiện trong tuần</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm">Tổng sự kiện</span>
