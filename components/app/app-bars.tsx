...
const AppBars = ({ children }: { children: React.ReactNode }) => {
	...
	return (
		...
		>
			...
			<NavSidebar activePage={activePage} isUiVisible={isUiVisible} />

			{/* === 2. Toolbar Phải (Đã cập nhật, không còn Avatar) === */}
			<ControlToolbar
				onChangeBackground={(url: string) => setBackgroundUrl(url)}
